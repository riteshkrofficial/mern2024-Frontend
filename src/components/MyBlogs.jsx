...
const MyBlogs = () => {
    ...
    const fetchBlog = async () =>{
        const api = await axios.get(`https://mern2024-90df.onrender.com/api/blogs/myblogs`,{
            headers:{
    ...
    const deleteBlog = async (id) =>{
        const api = await axios.delete(`https://mern2024-90df.onrender.com/api/blogs/${id}`,{
            headers:{
                "Content-Type":"application/json"
            },
            withCredentials:true,

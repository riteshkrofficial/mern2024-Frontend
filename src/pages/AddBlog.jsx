...
const AddBlog = () => {
    ...
    useEffect(() => {
        const fetchBlog = async () => {
            const api = await axios.get(`https://mern2024-90df.onrender.com/api/blogs/blog/${auth.id}`, {
                headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!auth.id) {
            try {
                const api = await axios.post(`https://mern2024-90df.onrender.com/api/blogs/new`, {
                    title,
                    description,
                    imgUrl
                },
            ...
            try {
                const api = await axios.put(`https://mern2024-90df.onrender.com/api/blogs/${auth.id}`, {
                    title,
                    description,
                    imgUrl
                },
